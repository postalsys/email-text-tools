...
const { describe, it, before: _before, after, beforeEach: _beforeEach, afterEach: _afterEach } = require('node:test');
...
describe('mime-html', () => {
    ...
    describe('concurrent processing', () => {
        ...
        it('should handle mixed content types concurrently', async () => {
            ...
            const results = await Promise.all(inputs.map(input => mimeHtml.async(input)));
