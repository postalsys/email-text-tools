...
function mimeHtml(message) {
    ...
    html = DOMPurify.sanitize(html, { WHOLE_DOCUMENT: true, FORCE_BODY: false, FORBID_TAGS: ['title', 'link', 'meta'] });
    ...
    const dom = DOMPurify.sanitize(html, { RETURN_DOM: true, WHOLE_DOCUMENT: false, FORCE_BODY: true, FORBID_TAGS: ['style', 'title', 'link', 'meta'] });
